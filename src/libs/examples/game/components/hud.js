    ...
    return (
      <div style={css.hud}>
        <h1>
          ...
          &nbsp;&nbsp;
          <span
            style={{ color: leftStick.heading ? onColor : offColor }}
          >{`LS(${leftStick.x.toFixed(2)}, ${leftStick.y.toFixed(2)})`}</span>
          &nbsp;&nbsp;
          <span
            style={{ color: leftTrigger ? onColor : offColor }}
          >{`LT(${leftTrigger.toFixed(2)})`}</span>
          &nbsp;&nbsp;
          <span
            style={{ color: rightStick.heading ? onColor : offColor }}
          >{`RS(${rightStick.x.toFixed(2)}, ${rightStick.y.toFixed(2)})`}</span>
          &nbsp;&nbsp;
          <span
            style={{ color: rightTrigger ? onColor : offColor }}
          >{`RT(${rightTrigger.toFixed(2)})`}</span>
          &nbsp;&nbsp;
